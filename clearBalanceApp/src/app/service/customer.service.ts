...
export class CustomerService {
   ...
   *
   * @returns Observable emitting a CustomHttpResponse containing the user and all customers.
   */
  getAllCustomers$(): Observable<CustomHttpResponse<{ user: any; customers: Customer[] }>> {
 ...
 */
  ...
  */
  ...
  /**
   * Downloads a CSV file containing all invoices generated by the backend.
   *
   * @returns Observable emitting the Blob of the CSV file
   */
  downloadAllInvoicesCsv$(): Observable<Blob> {
  ...
  /**
   * Downloads an Excel file containing all invoices generated by the backend.
   *
   * @returns Observable emitting the Blob of the Excel file
   */
  downloadAllInvoicesExcel$(): Observable<Blob> {
  ...
  /**
 * Downloads an Excel file containing all customers generated by the backend.
 *
 * @returns Observable emitting the Blob of the Excel file
 */
  downloadAllCustomersExcel$(): Observable<Blob> {
  ...
  /**
   * Downloads a CSV file containing all customers generated by the backend.
   *
   * @returns Observable emitting the Blob of the CSV file
   */
  downloadAllCustomersCsv$(): Observable<Blob> {
